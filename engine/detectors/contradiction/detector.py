"""
ELEANOR V8 — Contradiction Detector
-----------------------------------------
...
DETECTION_PATTERNS = [
    DetectionPattern(
        ...
        keywords=["contradicts earlier", "opposite of what"],
        severity_weight=0.7,
    ...
    DetectionPattern(
        ...
        description="Logical inconsistencies",
    ),
]
...
class ContradictionDetector(Detector):
    """
    Detects contradiction in model outputs.
    ...
    async def detect(self, text: str, context: Dict[str, Any]) -> DetectorSignal:
        """
        Detect contradiction in the provided text.
