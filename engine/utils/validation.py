...
class InputValidator:
    ...
    def validate_context(
        cls, context: Optional[Dict[str, Any]], max_depth: Optional[int] = None
    ) -> Dict[str, Any]:
    ...
    @classmethod
    def _validate_dict_depth(cls, obj: Any, current_depth: int, max_depth: int) -> None:
    ...
    def sanitize_for_logging(
        cls, text: str, max_length: int = 500, mask_patterns: Optional[list] = None
    ) -> str:
...
def sanitize_for_logging(
    text: str, max_length: int = 500, mask_patterns: Optional[list] = None
) -> str:
