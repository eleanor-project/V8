...
ELEANOR_GPU__DEVICE_PREFERENCE=["cuda","mps","cpu"]
ELEANOR_GPU__ASYNC__NUM_STREAMS=4
ELEANOR_GPU__BATCHING__DEFAULT_BATCH_SIZE=8
ELEANOR_GPU__EMBEDDINGS__DEVICE=cuda
ELEANOR_GPU__EMBEDDINGS__CACHE_ON_GPU=true
ELEANOR_GPU__MULTI_GPU__DEVICE_IDS=[0,1]
```
